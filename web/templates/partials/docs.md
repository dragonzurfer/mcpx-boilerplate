...
- `nav.html`: primary site navigation bar (public pages, including the re-enabled `Courses` link) with a Google sign-in button (`#nav-login`) wired by `web/assets/app.js`.
