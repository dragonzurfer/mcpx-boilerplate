...
- `home.html`: home page shell with newsletters hero, topic chips, feed loader/grid, and a sign-in CTA slot (`#cta-login`) rendered as a Google sign-in button by `web/assets/app.js`.
